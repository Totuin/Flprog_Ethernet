...
IPAddress google_server(81,177,141,85);  // numeric IP for Google (no DNS)
//char google_server[] = "www.flprog.ru";    // name address for Google (using DNS)
